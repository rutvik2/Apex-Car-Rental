 ...
 * @author Lenovo
 */
public class ListOfDrivers extends javax.swing.JFrame {
...
int p1=40,p2=40,p3=40,p4=60;
    /**
     * Creates new form ListOfDrivers
     */
    ...
    public void getDriverRecords()
  {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Driver ID", "Name", "Gender", "Address", "Phone No", "Experience", "Date Of Birth", "Joining Date"
            }
        ));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 180, 1009, 320));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/dps/img/gtgtg.jpg"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1010, 490));

        setSize(new java.awt.Dimension(1009, 518));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListOfDrivers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListOfDrivers().setVisible(true);
            }
        });
    }
