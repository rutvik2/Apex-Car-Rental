...
int p1=40,p2=40,p3=40,p4=60;
    ...
    public ReturnCar() {
       ...
       jTable1.setShowGrid(true);
        ...
        jTextField4.setBackground(new Color(0,0,0,80));
    ...
    private void initComponents() {
        ...
        getContentPane().add(jDateChooser1, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 120, 170, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Customer ID", "Name", "Phone No.", "Address", "Car Number"
            }
        ));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 350, 1005, 342));
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 110, 170, 30));

        jSeparator2.setForeground(new java.awt.Color(255, 255, 255));
        getContentPane().add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 140, 170, 10));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 100, 130, 40));

        jButton6.setFont(new java.awt.Font("Copperplate Gothic Light", 1, 16)); // NOI18N
        jButton6.setForeground(new java.awt.Color(255, 255, 255));
        jButton6.setText("car returned");
        ...
        getContentPane().add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 720, 180, 40));

        jTextField3.setEditable(false);
        jTextField3.setFont(new java.awt.Font("Times New Roman", 0, 16)); // NOI18N
        jTextField3.setForeground(new java.awt.Color(255, 255, 255));
        jTextField3.setBorder(javax.swing.BorderFactory.createEtchedBorder(null, java.awt.Color.white));
        jTextField3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField3ActionPerformed(evt);
            }
        });
        getContentPane().add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 280, 170, 30));

        jTextField4.setEditable(false);
        jTextField4.setFont(new java.awt.Font("Times New Roman", 0, 16)); // NOI18N
        jTextField4.setForeground(new java.awt.Color(255, 255, 255));
        jTextField4.setBorder(javax.swing.BorderFactory.createEtchedBorder(null, java.awt.Color.white));
        jTextField4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField4ActionPerformed(evt);
            }
        });
        getContentPane().add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 280, 170, 30));
        ...
        getContentPane().add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 280, 170, 30));

        jDateChooser2.setDateFormatString("yyyy-MM-dd");
        getContentPane().add(jDateChooser2, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 190, 170, -1));
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 180, 170, 40));

        jTextField2.setFont(new java.awt.Font("Times New Roman", 0, 16)); // NOI18N
        jTextField2.setForeground(new java.awt.Color(255, 255, 255));
        jTextField2.setBorder(null);
        jTextField2.setOpaque(false);
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 180, 170, 30));
        ...
        getContentPane().add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 210, 170, 10));

        jPanel2.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1010, 790));

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/dps/img/ddd.jpg"))); // NOI18N
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(1, 0, 1010, 790));

        setSize(new java.awt.Dimension(1013, 820));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        jTextField3.setText(""+dtm.getValueAt(jTable1.getSelectedRow(),4)); 
          try {  
       
         conn=crconn.getConnectionDB();
         
         String str="select model,servicecars.company,bdate from customerdetails,servicecars where customerdetails.carnumber=servicecars.carnumber AND customerid=?";
 
         psmt=conn.prepareStatement(str);
         psmt.setString(1,dtm.getValueAt(jTable1.getSelectedRow(),0).toString());
        ...
        jTextField5.setText(""+rst.getString(2));

           try
    {
    java.util.Date dob = new SimpleDateFormat("yyyy-MM-dd").parse(rst.getString(3));
 ...
 p1=40;
    ...
    jTextField3.setText(details[5]);
    jTextField4.setText(details[8]);
    jTextField5.setText(details[6]);
    try
    {
    java.util.Date dob = new SimpleDateFormat("yyyy-MM-dd").parse(details[7]);
   jDateChooser1.setDate(dob);
  ...
  String name=jTextField2.getText();
        try {  
         ...
         String str="select customerid,name,phoneno,address,servicecars.carnumber,model,servicecars.company,bdate from customerdetails,servicecars where customerdetails.carnumber=servicecars.carnumber AND name=?";
       ...
       while(rst.next())
       {
           dtm.addRow(new Object[]{rst.getString(1),rst.getString(2),rst.getString(3),rst.getString(4),rst.getString(5)} );
       }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
     id=jTextField1.getText();
         String rdate=((JTextField)jDateChooser2.getDateEditor().getUiComponent()).getText();
         if(crcon.returnCar(rdate, id))
              {
        ...
        jDateChooser2.setDate(null);
                   JOptionPane.showMessageDialog(this,"Car Returned","Update Successful",JOptionPane.ERROR_MESSAGE);
