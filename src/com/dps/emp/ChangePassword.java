...
int n=0;
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 0, 129, 40));
        ...
        jLabel23.setText("Driver Records");
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 0, 161, 40));
        ...
        getContentPane().add(jPanel39, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 0, 188, 40));
        ...
        jPanel3.add(jPanel26, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 190, 40));
        ...
        jPanel3.add(jPanel27, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 40, 190, 40));
        ...
        jPanel3.add(jPanel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 80, 190, 40));
        ...
        jLabel40.setText("List Of Employees");
        ...
        jPanel3.add(jPanel29, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 120, 190, 40));

        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 0, 190, 40));
        ...
        getContentPane().add(jPanel34, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 0, 140, 40));
        ...
        jLabel41.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/dps/img/sm.png"))); // NOI18N
        jLabel41.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabel41MouseClicked(evt);
            }
        });
        getContentPane().add(jLabel41, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, 51, 49));

        jLabel26.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/dps/img/mm.png"))); // NOI18N
        getContentPane().add(jLabel26, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 0, 990, 70));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 400, 130, 40));
        ...
        getContentPane().add(jPasswordField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 130, 170, 30));

        jSeparator2.setBackground(new java.awt.Color(0, 0, 0));
        jSeparator2.setForeground(new java.awt.Color(255, 255, 255));
        getContentPane().add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 160, 230, 10));

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/dps/img/hide.png"))); // NOI18N
        jLabel8.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabel8MouseClicked(evt);
            }
        });
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 130, -1, 30));
        ...
        getContentPane().add(jPasswordField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 200, 170, 30));

        jSeparator3.setBackground(new java.awt.Color(0, 0, 0));
        jSeparator3.setForeground(new java.awt.Color(255, 255, 255));
        getContentPane().add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 230, 230, 10));

        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/dps/img/hide.png"))); // NOI18N
        jLabel9.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabel9MouseClicked(evt);
            }
        });
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 200, -1, 30));
        ...
        jPasswordField3.setAutoscrolls(false);
        ...
        jPasswordField3.setSelectedTextColor(new java.awt.Color(0, 0, 0));
        jPasswordField3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jPasswordField3ActionPerformed(evt);
            }
        });
        getContentPane().add(jPasswordField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 290, 170, 30));

        jSeparator4.setBackground(new java.awt.Color(0, 0, 0));
        jSeparator4.setForeground(new java.awt.Color(255, 255, 255));
        getContentPane().add(jSeparator4, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 320, 230, 10));

        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/dps/img/hide.png"))); // NOI18N
        jLabel10.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabel10MouseClicked(evt);
            }
        });
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 290, -1, 30));
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/dps/img/hh.png"))); // NOI18N
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1030, 530));

        setSize(new java.awt.Dimension(1017, 563));
   ...
   p1=40;
    ...
    String cur=jPasswordField1.getText();
    String newp=jPasswordField2.getText();
    String con=jPasswordField3.getText();
        if(crcon.getPassword(Login.id()).equals(cur) && newp.equals(con))
        {
            if(crcon.changePsd(newp,Login.id()))
            {
    ...
    private void jLabel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MouseClicked
        ...
        if(n%2==1){
            ...
            jLabel8.setIcon(new ImageIcon(getClass().getResource("/com/dps/img/show.png")));
            jPasswordField1.setEchoChar((char)0);
        }
        if(n%2==0)
        {
            jLabel8.setIcon(null);
            jLabel8.setIcon(new ImageIcon(getClass().getResource("/com/dps/img/hide.png")));
    ...
    private void jLabel9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel9MouseClicked
        ...
        if(n%2==1){
            ...
            jLabel9.setIcon(new ImageIcon(getClass().getResource("/com/dps/img/show.png")));
            jPasswordField2.setEchoChar((char)0);
        }
        if(n%2==0)
        {
            jLabel9.setIcon(null);
            jLabel9.setIcon(new ImageIcon(getClass().getResource("/com/dps/img/hide.png")));
    ...
    private void jLabel10MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel10MouseClicked
        ...
        if(n%2==1){
            ...
            jLabel10.setIcon(new ImageIcon(getClass().getResource("/com/dps/img/show.png")));
            jPasswordField3.setEchoChar((char)0);
        }
        if(n%2==0)
        {
            jLabel10.setIcon(null);
            jLabel10.setIcon(new ImageIcon(getClass().getResource("/com/dps/img/hide.png")));
