...
int p1=40,p2=40,p3=40,p4=60;
    ...
    public void intoCombo()
    {
       ...
       jComboBox1.addItem("Car Companies");
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Car Companies" }));
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 190, 170, 30));

        jTextField1.setFont(new java.awt.Font("Times New Roman", 0, 16)); // NOI18N
        jTextField1.setForeground(new java.awt.Color(255, 255, 255));
        jTextField1.setBorder(null);
        jTextField1.setOpaque(false);
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 310, 170, 30));

        jSeparator3.setForeground(new java.awt.Color(0, 0, 0));
        getContentPane().add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 340, 170, 20));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 420, 150, 40));
        ...
        getContentPane().add(jLabel29, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 30, 51, 49));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 960, 530));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/dps/img/acd.jpg"))); // NOI18N
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 970, 530));

        setSize(new java.awt.Dimension(983, 582));
    ...
    if(crcon.addCompany(company))
    {
   
           jTextField1.setText("");
           jComboBox1.setSelectedItem("Car Companies");
           JOptionPane.showMessageDialog(this,"Successful","Car Company Added",JOptionPane.INFORMATION_MESSAGE);

    }
    else
    {
    JOptionPane.showMessageDialog(this,"An error occured","Car Company Not Added",JOptionPane.ERROR_MESSAGE);
    }
    intoCombo();
